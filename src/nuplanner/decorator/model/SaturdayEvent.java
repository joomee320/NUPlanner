...
/**
 * The class that creates an Event with the new Saturday Day enumeration.
 */
public class SaturdayEvent implements IEvent {
  private final String eventName;
  private final SaturdayDay startDay;
  private final LocalTime startTime;
  private final SaturdayDay endDay;
   ...
   */
  public SaturdayEvent(String name, SaturdayDay startDay,
                       LocalTime startTime, SaturdayDay endDay,
                       LocalTime endTime,
                       boolean online, String place,
                       IUser hostUser, List<IUser> invitedUsers) {
   ...
   */
  protected long calculateEventDurationInMinutes(SaturdayDay startDay, LocalTime startTime,
                                                 SaturdayDay endDay, LocalTime endTime) {
   ...
   */
  private boolean isValidEventDuration(SaturdayDay startDay,
                                       LocalTime startTime,
                                       SaturdayDay endDay,
                                       LocalTime endTime) {
  ...
  @Override
  public SaturdayDay getStartDay() {
    return startDay;
  }

  @Override
  public SaturdayDay getEndDay() {
    return endDay;
  }
